...
class AppSettings():
	...
	def createDefaultSettings(self):
		...
		self.actions.setValue('httpscreenshot-path','/usr/local/bin/httpscreenshot')
...
class Settings():
	def __init__(self, appSettings=None):
		...
		self.tools_path_httpscreenshot = "/usr/local/bin/httpscreenshot"
		...
		if appSettings:
			try:
				...
				self.tools_path_httpscreenshot = self.toolSettings['httpscreenshot-path']
